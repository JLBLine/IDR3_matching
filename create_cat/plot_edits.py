...
if options.combine_all_only:
	for choice in choices:
		try:
			...
			#else:
			if inc_names != 'r' and inc_names != 'v5':
		...
		##Otherwise, need to get the fiddled bayes info
			...
			for comp2 in bayes_fiddle:
				...
				if src_all2.names[0] == src_all.names[0]:
					...
					pol.create_plot_nocombo(comp,comp2,accepted_inds,xrange(len(matches)),this_match,match_crit,stage,accept_type,options.tag,choice_dict[src_all.names[0]])